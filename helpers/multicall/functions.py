...
strategy = DotMap(
    ...
    getTimelySupplyPosition="getTimelySupplyPosition()(uint256)",
    getTimelyBorrowPosition="getTimelyBorrowPosition()(uint256)",
    collateralTarget="collateralTarget()(uint256)",
    minWant="minWant()(uint256)",
)
